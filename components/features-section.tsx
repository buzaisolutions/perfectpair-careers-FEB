...
const features = [
  {
    ...
    description: 'Ensures your resume passes through company automatic tracking systems.',
  ...
  },
  {
    ...
    description: 'Fast optimization process with real-time feedback on improvements.',
  ...
  },
  {
    ...
    description: 'Generate documents in Portuguese, English or Dutch adapted to the European market.',
    color: 'text-blue-600',
    bgColor: 'bg-blue-100'
  },
  {
    icon: BarChart,
    title: 'ATS Score',
    description: 'Receive an ATS compatibility score and specific improvement suggestions.',
  ...
  },
  {
    ...
    description: 'Create optimized cover letters aligned with each specific job position.',
