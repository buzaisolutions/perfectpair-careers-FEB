        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            <div className="mb-6 inline-flex items-center rounded-full border bg-white/80 px-4 py-2 text-sm shadow-sm">
              ...
              AI-powered optimization for the European market
            </div>
            ...
            <p className="mb-8 text-xl text-gray-600 sm:text-2xl max-w-3xl mx-auto">
              Maximize your chances of passing ATS systems. Optimize resumes and cover letters 
              for specific job positions in Portuguese, English, or Dutch.
            </p>
            ...
            <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-3">
              ...
              >
                ...
                <p className="text-sm text-gray-600 text-center">
                  Portuguese, English and Dutch for the European market
                </p>
              </motion.div>
            </div>
          </motion.div>
