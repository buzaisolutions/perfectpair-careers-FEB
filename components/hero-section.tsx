  ...
  return (
    <section className="relative pt-20 pb-24 bg-gradient-to-b from-purple-50/50 to-white overflow-hidden">
      <div className="container flex flex-col items-center text-center space-y-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 pt-12 max-w-5xl mx-auto w-full px-4">
